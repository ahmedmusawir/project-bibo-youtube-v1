...
translation_prompt = (
    ...
    "MAKE SURE THE WORD 'Prompt' IS WRITTEN LIKE THIS  প্রম্প্ট -- if you don't do this exactly when we create audio out of this script it fails to pronounce it correctly ... you Must follow this exactly"
