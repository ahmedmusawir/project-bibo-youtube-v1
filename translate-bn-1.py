...
translation_prompt = (
    ...
    "PLEASE MAKE SURE IT IS SIMPLE + CONVESATIONAL + EASY BANGLA THAT PEOPLE FROM BANGLADESH CAN UNDERSTAND ... MAKE SURE A HIGHSCHOOL BOY OR GIRL CAN EASILY UNDERSTAND THIS"
    ...
    "MAKE SURE PROMPT IS WRITTEN LIKE THIS  প্রম্প্ট "
